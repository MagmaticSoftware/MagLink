...
return [
    ...
    */
    ...
    | confirmation page, will be available from. You're free to tweak
    | this path according to your preferences and application design.
    |
    */

    'path' => env('STRIPE_PATH', 'stripe'),
    ...
    */
    ...
    'currency_locale' => env('STRIPE_CURRENCY_LOCALE', 'it_IT'),
