...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'QR Codes',
        href: route('qrcodes.index') as string,
    },
    {
        title: props.item.name,
        href: route('qrcodes.edit', props.item.slug) as string,
    },
    {
        title: 'Analytics',
        href: route('qrcodes.analytics', props.item.slug) as string,
    },
];
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <div class="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-purple-500/20 to-purple-500/5 rounded-xl flex items-center justify-center">
                        <LucideQrCode :size="32" class="text-purple-600" />
                    </div>
                    <div>
                        ...
                        <p class="text-surface-600 dark:text-surface-400 mt-1">
                            Statistiche dettagliate QR Code
                        </p>
                    </div>
                </div>
                <Button 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="bg-white dark:bg-surface-900 rounded-xl p-6 shadow-sm border border-surface-200 dark:border-surface-800">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-sm font-medium text-surface-600 dark:text-surface-400">Scansioni Totali</span>
            ...
            <div class="bg-white dark:bg-surface-900 rounded-xl p-6 shadow-sm border border-surface-200 dark:border-surface-800">
                <h2 class="text-xl font-bold text-surface-900 dark:text-surface-50 mb-4">
                    Scansioni Giornaliere (Ultimi 30 giorni)
                </h2>
            ...
            <div class="bg-white dark:bg-surface-900 rounded-xl p-6 shadow-sm border border-surface-200 dark:border-surface-800">
                <h2 class="text-xl font-bold text-surface-900 dark:text-surface-50 mb-4">
                    Scansioni Recenti (con consenso)
                </h2>
                ...
                <div v-else class="text-center py-12 text-surface-500 dark:text-surface-400">
                    Nessuna scansione con consenso registrata
                </div>
            </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-blue-800 dark:text-blue-200">
                            ...
                            Le {{ stats.overview.anonymous }} scansioni anonime non includono informazioni personali o di tracciamento.
                        </p>
                    </div>
                </div>
            </div>
