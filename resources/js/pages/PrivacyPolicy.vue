...
<template>
    <Head title="Privacy Policy — MagLink">
        <meta name="description" content="Privacy Policy di MagLink — Informativa sul trattamento dei dati personali ai sensi del GDPR." />
    ...
    <div class="min-h-screen bg-[#13131c] text-white flex flex-col">
        ...
        <main class="flex-1 py-16">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <!-- iubenda body embed — replaced in-place by iubenda.js -->
                <div class="bg-white rounded-2xl shadow-2xl shadow-black/40 overflow-hidden">
                    <a
                        href="https://www.iubenda.com/privacy-policy/43214913"
                        class="iubenda-nostyle no-brand iubenda-embed iub-legal-only iub-body-embed"
        ...
        <!-- Footer -->
        <footer class="bg-[#0d0d14] border-t border-white/[0.07] py-8 mt-auto">
