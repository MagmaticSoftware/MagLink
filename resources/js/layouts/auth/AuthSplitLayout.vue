...
<template>
    <div class="relative grid min-h-screen flex-col lg:grid-cols-2">
        ...
        <div class="relative hidden h-full flex-col bg-gradient-to-br from-orange-600 via-orange-700 to-orange-800 dark:from-orange-900 dark:via-orange-950 dark:to-red-950 p-10 text-white lg:flex overflow-hidden">
            <!-- Background Pattern -->
